...
<script type="module" src="https://static.rocket.new/rocket-web.js?_cfg=https%3A%2F%2Fbaimsapp5319back.builtwithrocket.new&_be=https%3A%2F%2Fapplication.rocket.new&_v=0.1.8"></script>
...
<body>
  ...
  <main>
    <section class="hero-section">
      <img src="images/learningPicture.jpg" alt="Learning background" class="hero-bg-image" />
      <!-- <img src="../assets/images/img_image_15.png" alt="Students learning" class="hero-overlay-image" /> -->
      ...
      <div class="hero-content">
        ...
        <button class="hero-btn">
          Find courses
          <img src="/images/blueLeftArrow.png" alt="" width="58" height="58" />
        </button>
      </div>
    </section>
    ...
    <section class="about-section">
      <div class="about-content">
        <div class="about-images">
          <img src="images/fotoCewek1.png" alt="Student learning" width="152" height="362" margin_bottom ="50" />
          <img src="images/ijoIjojelek.png" alt="Learning materials" width="66" height="74" />
          <img src="images/fotoCewek2.png" alt="Online education" width="214" height="344" />
        </div>
    ...
    <section class="stats-section">
      <div class="stats-container">
        <div class="stat-item">
          <div class="stat-icon">
            <img src="images/sucessfullyTrained.png" alt="Successfully trained icon" width="38" height="38" class="stat-icon-large"/>
          </div>
        ...
        <div class="stat-item">
          <div class="stat-icon">
            <img src="images/classesComplete.png" alt="Classes completed icon" width="38" height="38"class="stat-icon-large"/>
          </div>
        ...
        <div class="stat-item">
          <div class="stat-icon">
            <img src="images/satisfactionRate.png" alt="Satisfaction rate icon" width="38" height="38" class="stat-icon-large"/>
          </div>
        ...
        <div class="stat-item">
          <div class="stat-icon">
            <img src="images/expertReaction.png" alt="Expert instructor icon" width="38" height="38" class="stat-icon-large" />
          </div>
    ...
    <section class="courses-section">
      ...
      <div class="courses-grid">
        <article class="course-card">
          <img src="../assets/images/img_image_24.png" alt="IT Statistics Data Science course" class="course-image" />
          <div class="course-rating">
            <img src="../assets/images/img_symbol.svg" alt="5 star rating" width="78" height="14" />
            <span>4.5k</span>
          </div>
          <h3 class="course-title">It Statistics Data Science And Business Analysis</h3>
          <div class="course-meta">
            <span><img src="../assets/images/img_symbol_black_900.svg" alt="Duration" width="32" height="14" /> 19h 30m</span>
            <span><img src="../assets/images/img_symbol_black_900_14x30.svg" alt="Students" width="30" height="14" /> Students 20+</span>
          </div>
        </article>

        <article class="course-card">
          <img src="../assets/images/img_image_25.png" alt="Adobe Illustrator course" class="course-image" />
          <div class="course-rating">
            <img src="../assets/images/img_symbol.svg" alt="5 star rating" width="78" height="14" />
            <span>4.5k</span>
          </div>
        ...
        <article class="course-card">
          <img src="../assets/images/img_image_26.png" alt="Classical Music Piano course" class="course-image" />
          <div class="course-rating">
            <img src="../assets/images/img_symbol.svg" alt="5 star rating" width="78" height="14" />
            <span>4.5k</span>
          </div>
      ...
      <div class="categories-grid">
        <div class="category-item" style="background-color: #eaf6ff;">
          <div class="category-icon" style="background-color: rgba(27, 117, 232, 0.1); border: 1px solid #1b75e8;">
            <img src="../assets/images/img_svg_blue_600.svg" alt="Business icon" width="40" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #fef2f4;">
          <div class="category-icon" style="background-color: rgba(255, 104, 129, 0.15); border: 1px solid #ff6881;">
            <img src="../assets/images/img_svg_pink_300.svg" alt="Music icon" width="40" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #eefbf5;">
          <div class="category-icon" style="background-color: #d1f5e4; border: 1px solid #00bc65;">
            <img src="../assets/images/img_svg_green_a700.svg" alt="IT icon" width="46" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #fffaef;">
          <div class="category-icon" style="background-color: #fff3d9; border: 1px solid #f2a700;">
            <img src="../assets/images/img_svg_amber_a700.svg" alt="Art icon" width="38" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #f7f3ff;">
          <div class="category-icon" style="background-color: #dfd4f4; border: 1px solid #4500d0;">
            <img src="../assets/images/img_svg_deep_purple_a700.svg" alt="Language icon" width="40" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #fff0f8;">
          <div class="category-icon" style="background-color: #ffdaf0; border: 1px solid #bb0064;">
            <img src="../assets/images/img_svg_pink_a700.svg" alt="Lifestyle icon" width="40" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #f3f4fe;">
          <div class="category-icon" style="background-color: #dcdffd; border: 1px solid #0011bb;">
            <img src="../assets/images/img_svg_blue_900.svg" alt="Cooking icon" width="40" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #fff7ef;">
          <div class="category-icon" style="background-color: #ffecd9; border: 1px solid #d16900;">
            <img src="../assets/images/img_svg_orange_800.svg" alt="Professional icon" width="42" height="40" />
          </div>
        ...
        <div class="category-item" style="background-color: #f1fbff;">
          <div class="category-icon" style="background-color: #dcf5ff; border: 1px solid #00a9ed;">
            <img src="../assets/images/img_svg_light_blue_500.svg" alt="Health icon" width="40" height="40" />
          </div>
          ...
          <ul class="plan-features">
            <li>
              <div class="check-icon">
                <img src="../assets/images/img_symbol_light_green_700_03.svg" alt="Check" width="8" height="12" />
              </div>
        ...
        <div class="pricing-card featured">
          ...
          <ul class="plan-features">
            ...
            <li style="color: #ffffff;">
              ...
              Interactive discussions with Instructor
            </li>
            <li style="color: #ffffff;">
              <div class="check-icon">
                <img src="../assets/images/img_symbol_light_green_700_03.svg" alt="Check" width="8" height="12" />
            ...
            <li style="color: #ffffff;">
              ...
              Free practice before certification
            </li>
          </ul>
        ...
        <div class="pricing-card">
          ...
          <ul class="plan-features">
            ...
            <li>
              ...
              Certification from Global institution
            </li>
            <li>
              <div class="check-icon">
                <img src="../assets/images/img_symbol_light_green_700_03.svg" alt="Check" width="8" height="12" />
              </div>
              Online/ F2F guidance by expert instructors
            </li>
            <li>
              <div class="check-icon">
                <img src="../assets/images/img_symbol_light_green_700_03.svg" alt="Check" width="8" height="12" />
  ...
  <footer class="footer">
    <div class="footer-content">
      <div class="footer-brand">
        <img src="../assets/images/img_footer_logo.png" alt="AllnGrow Footer Logo" class="footer-logo" />
